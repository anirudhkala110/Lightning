    ...
    return (
        <div className='text-white bg-dark container'>
            <div className='text-white pt-2 d-flex align-items-start justify-content-between' style={{ display: '' }} data-aos="slide-right" data-aos-delay='100' data-aos-anchor-easing='ease-in-out' data-aos-duration='1000' data-aos-mirror='false'>
                <Link className='text-decoration-none text-white' target='__blank' to='https://wa.me/+918005183363'><i class="bi bi-whatsapp"> Whatsapp</i> </Link>
                <Link className='text-decoration-none text-white' target='__blank' to='https://www.instagram.com/slogfy?igsh=MXdraDhpbzlxaHk1Zg=='><i class="bi bi-instagram"> Instagram</i> </Link>
