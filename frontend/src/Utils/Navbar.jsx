        ...
        <div className=''>
            {/* <nav className="navbar w-100 rounded-0 py-0" id="sidebar" style={{ background: 'black', borderBottom: '0px solid' }}> */}
                {/* <div className="d-flex w-100 justify-content-between align-items-center "> */}
                    <div id="navbar" className='bg-black d-flex justify-content-between' style={{ padding: isScrolled ? '2px 2px' : '15px 15px',maxHeight: isScrolled ? '80px' : '', transition: 'padding 0.3s',borderBottom:'5px solid #090b39' }} >
